 ...
 */
/*
 * HYBRID FILE (rust-ui branch): the bulk of this file is still generated
 * from the deprecated Python backend's OpenAPI spec, because the Rust
 * gateway's utoipa spec renames every operationId and several schemas the
 * UI references (ItemRecord -> ItemRecordResponse, PQLQuery -> PqlQuery,
 * ...). The /api/pinboards paths, operations, and Pinboard* schemas below
 * are grafted in from the Rust gateway's /openapi.json (gateway branch:
 * pinboards). TODO(alignment): regenerate the whole file from the gateway
 * spec and sweep the UI's operations[...]/schemas[...] references once the
 * Python backend is retired.
 */
...
export interface paths {
    ...
    "/api/jobs/data/history": {
        ...
        delete: operations["delete_scan_data_api_jobs_data_history_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        JobModel: {
             ...
             * @enum {string}
             */
            job_type: "data_extraction" | "data_deletion" | "folder_rescan" | "folder_update" | "job_data_deletion";
            /** Index Db */
            index_db: string;
            /** Metadata */
...
export interface operations {
    ...
    delete_scan_data_api_jobs_data_history_delete: {
        parameters: {
            query: {
                log_ids: number[];
                /** @description The name of the `index` database to open and use for this API call. Find available databases with `/api/db` */
