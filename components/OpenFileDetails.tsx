    ...
    return (
        variantButton ? (
            <Button
                ...
                className="cell-chrome-pill absolute bottom-(--cell-chrome-inset) left-(--cell-chrome-inset) h-(--cell-chrome-box) w-(--cell-chrome-box) opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                size="icon"
            >
