        ...
        >
            <div>
                <CommandInput
                    ...
                    disabled={disabled}
                    className={cn(
                        "flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50", "grow", inputClassName)}
                />
            </div>
            <div className="relative mt-1">
                <div
                    className={cn(
                        ...
                        "absolute top-1 z-10 max-w-full outline-hidden rounded-md border bg-popover p-2 text-popover-foreground shadow-md",
                        isOpen ? "block" : "hidden",
                        popoverClassName
                    )}
                >
